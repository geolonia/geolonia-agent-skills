...
いずれも upstream の対応待ちで `tmp/geolonia-maps/sdk/issues/maps-suite/` に issue として
記録済み（このワークスペース内のみ）。対処されるまではここに書く回避策を使うこと。
upstream で修正されたら該当 issue ファイルと、このリファレンスの記述を更新すること。
...
→ 追跡: `tmp/geolonia-maps/sdk/issues/maps-suite/missing-polyline.md`
...
→ 追跡: `tmp/geolonia-maps/sdk/issues/maps-suite/missing-symbol-path-circle.md`
...
→ 追跡: `tmp/geolonia-maps/sdk/issues/maps-suite/panto-cancelled-by-setzoom.md`
